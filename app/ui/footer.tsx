...
import Instagram_Logo from "@/public/images/Instagram_Glyph_White.svg";

const navigation = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61558798413924",
    icon: () => (
      <Image src={Facebook_Logo} alt="Facebook Logo" width={20} height={20} />
    ),
  },
  {
	name: "Instagram",
